...
ax.plot(range(num_epochs), reg_vit[:num_epochs], color="orange", label='Unquantized Model, lr=1e-3')
ax.plot(range(num_epochs), lowlr_vit[:num_epochs], color="orange", label='Unquantized Model, lr=5e-4', linestyle='--')
